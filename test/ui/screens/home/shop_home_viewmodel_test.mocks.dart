...
// in offro_cibo/test/ui/screens/home/shop_home_viewmodel_test.dart.
...
import 'package:offro_cibo/domain/entities/food.dart' as _i7;
import 'package:offro_cibo/domain/providers/user_provider.dart' as _i9;
...
class MockShopFoodRepositoryApi extends _i1.Mock
    implements _i6.ShopFoodRepositoryApi {
  ...
  _i3.Future<_i4.RequestStatus> addFood(
    _i7.Food? newFood,
    _i8.ImageSelectedWrapper? imageSelected,
  ) =>
      (super.noSuchMethod(
        Invocation.method(
          #addFood,
...
///
/// See the documentation for Mockito's code generation for more information.
class MockUserProviderApi extends _i1.Mock implements _i9.UserProviderApi {
  MockUserProviderApi() {
    _i1.throwOnMissingStub(this);
  }
}
